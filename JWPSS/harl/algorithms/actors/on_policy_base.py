...
class OnPolicyBase:
    ...
    def get_actions(
        self, obs, rnn_states_actor, masks,avaliable_actions_agent, available_actions=None, deterministic=False
    ):
        ...
        """
        # print("detemrinistic********",deterministic)
        actions, action_log_probs, rnn_states_actor = self.actor(
            obs, rnn_states_actor, masks, avaliable_actions_agent,available_actions, deterministic
        )
