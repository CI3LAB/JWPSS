...
class StochasticPolicy(nn.Module):
    ...
    def forward(
        self, obs, rnn_states, masks, avaliable_actions_agent, available_actions=None, deterministic=False
    ):
        ...
        if avaliable_actions_agent is not None:
            avaliable_actions_agent = check(avaliable_actions_agent).to(**self.tpdv)
        ...
        actions, action_log_probs = self.act(
            actor_features, avaliable_actions_agent, available_actions, deterministic
        )
