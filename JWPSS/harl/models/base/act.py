...
class ACTLayer(nn.Module):
    ...
    def forward(self, x, avaliable_actions_agent, available_actions=None, deterministic=False):
        ...
        if self.multidiscrete_action:
            ...
            action_distribution = self.action_out(x, available_actions, avaliable_actions_agent)
